...
/**
 * RegistrationDataHelper with helper methods.
 *
 * @author "Jigar Gosalia"
 */
public class RegistrationDataHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "RegistrationDatabase.db";

    public static final String TABLE_NAME = "registration";

    private static final String SQL_CREATE = "CREATE TABLE " + TABLE_NAME +
            " ( " + RegistrationProvider._ID + " INTEGER PRIMARY KEY, app_name TEXT, install_date TEXT, last_date TEXT )";

    private static final String SQL_DROP = "DROP TABLE IS EXISTS " + TABLE_NAME ;

    public RegistrationDataHelper(Context context) {
