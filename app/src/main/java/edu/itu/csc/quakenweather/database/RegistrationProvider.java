...
public class RegistrationProvider extends ContentProvider {
    ...
    private static final String PROVIDER_NAME = "edu.itu.csc.quakenweather";
    ...
    private RegistrationDataHelper dateDataHelper = null;

    @Override
    public boolean onCreate() {
        Context context = getContext();
        dateDataHelper = new RegistrationDataHelper(context);
        return true;
    }
